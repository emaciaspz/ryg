...
/**
 * @typedef {Object} Siniestro
 * @property {number} idSiniestro PRIMARY KEY,
 * @property {number} caso_id,
 * @property {number} caso_n_siniestro,
 * @property {string} estado
 * @property {string} estado_real
 * @property {string} caso_fech_ocurren
 * @property {string} cia_seg
 * @property {string} asegurados
 * @property {string} ajustador
 * @property {string} causas
 * @property {string} perdidaEstimada
 * @property {string} caso_n_poliza
 * @property {string} caso_direccion
 * @property {string} regiones
 * @property {string} comunas
 * @property {string} caso_fech_ini_poliza
 * @property {string} caso_fech_fin_poliza
 * @property {string} corredores
 * @property {string} beneficiarios
 */

/** 
 * @typedef {Object} CatalogoMoneda
 * @property {number} moneda_id PRIMARY KEY
 * @property {number} moneda_user
 * @property {number} moneda_estado
 * @property {string} moneda_nombre
 * @property {string} moneda_simbolo
 * @property {string} moneda_id_penta
 * @property {string} moneda_nombre_penta
 * @property {string} moneda_fecha
 */

/**
 * @typedef {Object} CatalogoConcepto
 * @property {number} concepto_id PRIMARY KEY,
...
/**
 * Almacena todas las migraciones
 */
const Migraciones = {
	inicial() {
