 ...
 * @param {number|string} inspeccion_id Id de inspeccion del servidor
 * @param {number|string} idInspeccion id inspeccion local
 * @param {number|string} numSin numero siniestro
 */
...
/**
 * Muestra los detalles de la inspeccion
...
function mostrarInspeccion(idInspeccion) {
    ...
    InspeccionService.obtenerDetallePorIdInspeccion(idInspeccion)
        ...
        .then(informacion => {
            console.error('siniestro', informacion.siniestro)
            ...
            $('#fechaSiniestro').val(siniestro.caso_fech_ocurren);
            $('#idInspector').val(inspeccion.inspector);
...
/**
 * Muestra el estado de la inspeccion en el formulario
 */
...
/** 
 * Muestra la pantalla para crear una inspecion
 */
...
/**
 * Carga la informacion para la pantalla de nueva inspeccion
...
function crearInspeccion() {
    ...
    console.error('creando inspeccion', inspeccion_inspector, $('[data-ajustador-id]').val());
...
/**
 * Guarda los detalles de la inspeccion utilizando el formulario
 */
 ...
 *******************************************************************/
/**
 * Carga la pagina que se muestra cuando no hay siniestro
 */
...
/**
 * Funcion para validar la busqueda sin siniestro
 */
 ...
 * @param {{registros: number, resultados: Array<Inspeccion>}} lstInspecciones 
 * @param {*} pageActual 
 * @param {*} numSin 
 */
...
/**
 * Abre la pantalla para enviar la inspección por correo
 */
...
/** 
 * Valida el formaulario para enviar inspeccion por correo
 */
...
/**
 * Función para enviar el mail con los datos de la inspeccion del 
 * siniestro
 */
function saveEmail() {
    var casos = window.localStorage.getItem("idSiniestroServidor");
    var contacto_mail = $("#contacto_mail").val();
...
/** 
 * Formulario para guardar y restaurar el formulario de inspeccion
 */
var FormularioInspeccion = {
    ...
    guardarCambiosFormulario() {
        ...
        console.error('guardando cambios formulario', datos);
